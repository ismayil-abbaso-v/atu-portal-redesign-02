...
const menuHubMessages = {
  az: {
    ...
    heroEyebrow: "Şəxsi idarəetmə mərkəzi",
    heroTitle: "Şəxsi kabinet",
    heroSubtitle: "Profil, təhlükəsizlik, görünüş və akademik seçimlərinizi bir məkandan rahat idarə edin.",
    sectionEyebrow: "İdarəetmə",
    sectionTitle: "Hesab və parametrlər",
  ...
  tr: {
    ...
    heroEyebrow: "Kişisel yönetim merkezi",
    heroTitle: "Kişisel portal",
    heroSubtitle: "Profil, güvenlik, görünüm ve akademik tercihlerinizi tek bir yerden kolayca yönetin.",
    sectionEyebrow: "Yönetim",
    sectionTitle: "Hesap ve ayarlar",
  ...
  en: {
    ...
    heroEyebrow: "Personal management center",
    heroTitle: "Personal portal",
    heroSubtitle: "Manage your profile, security, appearance and academic preferences conveniently from one place.",
    sectionEyebrow: "Management",
    sectionTitle: "Account and settings",
  ...
  ru: {
    ...
    heroEyebrow: "Центр персонального управления",
    heroTitle: "Личный кабинет",
    heroSubtitle: "Управляйте профилем, безопасностью, оформлением и академическими настройками в одном месте.",
    sectionEyebrow: "Управление",
    sectionTitle: "Аккаунт и настройки",
