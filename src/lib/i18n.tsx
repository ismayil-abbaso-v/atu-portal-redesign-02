...
const commonAz: Messages = {
  ...
  "nav.main": "Əsas",
  "nav.more": "Əlavə",
  "nav.additionalServices": "Əlavə xidmətlər",
  "nav.openAdditionalMenu": "Əlavə menyunu aç",
  "nav.closeAdditionalMenu": "Əlavə menyunu bağla",
  "nav.allServices": "Bütün xidmətlər",
...
const messages: Record<Locale, Messages> = {
  ...
  tr: {
    ...
    "nav.menu": "Menü", "nav.home": "Ana sayfa", "nav.calendar": "Takvim", "nav.exams": "Sınavlar", "nav.chat": "Sohbet", "nav.library": "Kütüphane", "nav.office": "Ofis", "nav.notifications": "Bildirimler", "nav.profile": "Profil", "nav.settings": "Ayarlar", "nav.security": "Güvenlik", "nav.logout": "Çıkış", "nav.facultyOverview": "Fakülte özeti", "nav.groups": "Gruplar", "nav.admin": "Yönetim paneli", "nav.main": "Ana", "nav.more": "Ek", "nav.additionalServices": "Ek hizmetler", "nav.openAdditionalMenu": "Ek menüyü aç", "nav.closeAdditionalMenu": "Ek menüyü kapat", "nav.allServices": "Tüm hizmetler",
