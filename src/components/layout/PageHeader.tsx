...
const HEADER_COPY: Record<Locale, HeaderCopy> = {
  az: {
    ...
    transcriptDescription:
      "Semestrlər, kreditlər və ümumi akademik göstəricilərinizi rəsmi sənəd quruluşunda izləyin.",
  ...
  tr: {
    ...
    calendarEyebrow: "Akademik planlayıcı",
    calendarDescription:
      "Derslerinizi, sınavlarınızı ve akademik etkinliklerinizi tek bakışta takip edin.",
    transcriptEyebrow: "Akademik transkript",
    transcriptDescription:
      "Dönemlerinizi, kredilerinizi ve genel akademik göstergelerinizi resmi belge düzeninde takip edin.",
  ...
  en: {
    ...
    transcriptDescription:
      "Track semesters, credits, and overall academic indicators in an official document layout.",
  ...
  ru: {
    ...
    calendarDescription:
      "Следите за занятиями, экзаменами и академическими событиями в одном месте.",
    transcriptEyebrow: "Академический транскрипт",
    transcriptDescription:
      "Отслеживайте семестры, кредиты и общие академические показатели в формате официального документа.",
...
export function PageHeader({
  ...
  if (isAdminHeader) {
    return (
      <header className="admin-page-header surface-card relative mb-6 overflow-hidden px-5 py-5 sm:px-7 sm:py-6">
        ...
        <svg
          aria-hidden
          className="admin-page-header__network"
          viewBox="0 0 860 150"
          preserveAspectRatio="none"
        >
          <path
            className="admin-page-header__line"
            d="M18 111 L116 62 L218 96 L322 42 L432 83 L552 34 L672 78 L838 35"
          />
          <path
            className="admin-page-header__line admin-page-header__line--soft"
            d="M74 132 L178 104 L282 125 L392 79 L505 118 L618 88 L742 111 L846 76"
          />
          <path
            className="admin-page-header__flow"
            d="M18 111 L116 62 L218 96 L322 42 L432 83 L552 34 L672 78 L838 35"
          />
          <path
            className="admin-page-header__flow admin-page-header__flow--two"
            d="M74 132 L178 104 L282 125 L392 79 L505 118 L618 88 L742 111 L846 76"
          />
        ...
        <div className="admin-page-header__content relative z-10 flex min-h-[72px] items-center gap-3 sm:gap-4">
          ...
          <div className="admin-page-header__visual hidden shrink-0 sm:flex" aria-hidden>
            ...
            <span className="admin-page-header__core">
              <ShieldCheck className="size-6" />
            </span>
          </div>

          {children ? (
            <div className="admin-page-header__actions ml-auto flex shrink-0 items-center gap-2">
              {children}
            </div>
          ) : null}
        </div>
  ...
  if (isTranscriptHeader) {
    return (
      <header
        className="transcript-page-header surface-card relative mb-6 overflow-hidden px-5 py-5 sm:px-7 sm:py-6"
        style={{ backgroundImage: `url(${transcriptHero})` }}
      >
